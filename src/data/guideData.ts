...
export const stepsAct3: Step[] = normalizeSteps([
  ...
  { text: 'Talk to NPC (main quest) and kill the three Soul Repositories. Talk to NPC again and portal to town', npcs: ['Main Quest NPC'], enemies: ['Soul Repository'] },
  ...
  { text: 'Continue south-east, enter Time Rift to The Ancient Forest. Go north-east and kill the Primeval Dragon. Take waypoint to The Shattered Valley in the Ruined Era', areas: ['The Shattered Valley'], enemies: ['Primeval Dragon'] },
...
export const stepsAct4: Step[] = normalizeSteps([
  ...
  { text: 'Follow quest marker north-west then west, kill Admiral Harton. Talk to NPCs (Alric) and the Dreadnought’s Railing.', direction: 'north-west, west', enemies: ['Admiral Harton'], npcs: ['Alric', 'The Dreadnought’s Railing'] },
]);
...
export const stepsAct5: Step[] = normalizeSteps([
  ...
  { text: 'Talk to NPC (Alric), go downstairs, continue south-east, kill Venator Ealos, talk to NPC, continue north-east and kill the Bone Furnace before entering The Sapphire Quarter', npcs: ['Alric'], enemies: ['Venator Ealos', 'Bone Furnace'] },
  { text: 'Continue north, kill the Stygian Warden, talk to NPC, continue north-west and north, kill Praetor Vul’arta, talk to NPC and enter portal to Maj’elka', areas: ['Maj’elka'], enemies: ['Stygian Warden','Praetor Vul’arta'] },
...
export const stepsEndgame: Step[] = normalizeSteps([
  ...
  { text: 'Continue west to quest marker, enter The Nomad Camp, talk to NPC (Nomad Survivor), then enter The Nomad Camp', areas: ['The Nomad Camp'], direction: 'west', npcs: ['Nomad Survivor'] },
  { text: 'Follow side quest markers, kill Wengari Beastmaster, kill Wengari Matriarch and Patriarch, talk to NPC (Blessed Horn), then take waypoint to The Ice Caverns', areas: ['The Ice Caverns'], enemies: ['Wengari Beastmaster','Wengari Matriarch','Wengari Patriarch'], npcs: ['Blessed Horn'] },
  { text: 'Go north-east to enter The Tundra', areas: ['The Tundra'], direction: 'north-east' },
  { text: 'Kill the Eber and continue north to enter The Temple of Heorot', areas: ['The Temple of Heorot'], direction: 'north', enemies: ['Eber'] },
  ...
  { text: 'Talk to NPC (Grael), continue north-east to enter The Tomb of Morditas, kill the Frostroot Warden, talk to NPCs', areas: ['The Tomb of Morditas'], direction: 'north-east', npcs: ['Grael'], enemies: ['Frostroot Warden'] },
