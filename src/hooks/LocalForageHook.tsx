...
export const useLocalForage = <T extends any>( key: string, initialValue?: T ): HookMethods<T> =>{
  const [storedValue, setStoredValue] = React.useState<T|null>(initialValue??null);
