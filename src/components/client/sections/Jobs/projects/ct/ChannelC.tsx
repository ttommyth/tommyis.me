...
const googlePlayUrl =
  'https://play.google.com/store/apps/details?id=com.channelchk.mobileapp';
  ...
  return (
    <div className="flex flex-col gap-4">
      <DeviceContainer url={'https://channelchk.com'} deviceType={'browser'}>
        <ImageCarousel
          images={Array.from(new Array(2)).map(
            (_, idx) => `/image/project/cc/${idx + 1}.png`,
          )}
        />
      </DeviceContainer>
      ...
      <div className="flex flex-col sm:flex-row gap-4 items-center">
        <div className="max-w-full">
          <DeviceContainer
            url={'https://channelchk.com/app'}
            deviceType={'mobile'}
          >
            <ImageCarousel
              images={Array.from(new Array(4)).map(
                (_, idx) => `/image/project/cc/app/${idx + 1}.jpeg`,
              )}
            />
          </DeviceContainer>
        </div>
